...
<t:layout pageName="회원가입">
  ...
  <jsp:body>
    ...
    <form>
      ...
      <label>
        비밀번호
        <input class="short-input mb-mid" name="password" type="password" placeholder="비밀번호" id="pw" autocomplete="new-password" required>
      </label>
      <label>
        비밀번호 확인
        <input class="short-input mb-mid" name="repassword" type="password" placeholder="비밀번호 재입력" id="rpw" autocomplete="new-password"  required>
      </label>
      <label>
        닉네임 (표시할 이름)
